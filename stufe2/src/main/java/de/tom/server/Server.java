...
public class Server {
    public static final ConcurrentMap<ClientId, Queue<Message>> queues = new ConcurrentHashMap<>();
    public static final ConcurrentMap<ClientId, ServerConnection> openConnections = new ConcurrentHashMap<>();
